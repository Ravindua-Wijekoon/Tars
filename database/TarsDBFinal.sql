...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2024 at 03:13 PM
...
(4, 'ggggg@123.com', '123', 'mm', 'mmm', 'mmm', 'mmm@123.com', 'mmmm', 'mmmm', 'mmm'),
(5, 'xyz@123', '0000', 'Bank Trust', 'UI/Ux', 'Colombo', 'xyz@123', '                nnnnnnnn       ', 'vvvvvv', 'vvvvvv');
...
--
-- Table structure for table `company_post_job`
--
...
INSERT INTO `company_post_job` (`id`, `title`, `description`, `location`, `qualification`, `type`, `email`) VALUES
(1, 'ffff', '                        fffff', 'fff', 'fff', 'Onsite', 'ggggg@123.com'),
(2, 'hhhh', '                        hhhhh', 'hhh', 'hhh', 'Remote', 'ggggg@123.com'),
(3, 'nnnn', '                        nnnnn', 'nnnnn', 'bbbb', 'Onsite', 'ggggg@123.com'),
(4, 'xxxxxxxx', '                        xxxxxxxxxxxx', 'xxxxxxxxx', 'xxxxxxxxxxx', 'Remote', 'ggggg@123.com'),
(5, 'chamod', '                        chamod', 'piliyandala', 'xxxxx', 'Onsite', 'ggggg@123.com'),
(6, 'ravi', '                        ravi', 'ampara', 'xxx', 'Onsite', '334@123'),
(7, 'chakshu', '                       chakshu', 'walitharage', 'ss', 'Remote', '334@123'),
(8, 'uuuu', '                        uuuuu', 'uuuu', 'uuuu', 'Onsite', 'xyz@123');
...
(47, 'oo', '2024-04-24', '2024-04-15', 'yyyy223'),
(48, 'll', '2024-04-24', '2024-04-15', 'yyyy223');
...
(23, 'oo', '2024-04-12', '2024-04-16', 'yyyy223'),
(24, 'mm', '2024-04-09', '2024-04-15', 'yyyy223');
...
(28, 'aaa123', 'Get old data from DB', '234', 'Get old data from DB', 'aaaaaaaaaaa', 'aaaaaaaaa', '', 'Get old data from DB', 'Get old data from DB', 89, 'Get old data from DB', 'Get old data from DB', 'Get old data from DB'),
...
(40, 'yyyy223', 'ooooo', '234', 'ooo', 'yyyyy', 'yyyyy', '2024-04-04', 'oooooo', 'oooo', 0, 'ff', 'ff', 'ff');
...
--
-- Indexes for table `company_post_job`
--
ALTER TABLE `company_post_job`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `company_post_job`
--
ALTER TABLE `company_post_job`
