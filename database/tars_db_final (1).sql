...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2024 at 04:03 AM
...
--
-- Dumping data for table `company_info_temp`
--

INSERT INTO `company_info_temp` (`id`, `email`, `password`, `name`, `type`, `location`, `com_email`, `about`, `linkedin`, `twitter`) VALUES
(4, 'fffff44444', '123', 'dd', 'dd', 'dd', 'dd', '         dd               ', 'dd', 'dd');
